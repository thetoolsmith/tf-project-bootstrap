...
resource "aws_kms_alias" "key-alias" {
  name          = join("/", ["alias", local.secrets_unique_name])
...
data "aws_iam_policy_document" "iam-role-policy" {
  statement {
    ...
    principals {
      type        = "Service"
      identifiers = ["ec2.amazonaws.com", "acm-pca.amazonaws.com", "acm.amazonaws.com", "eks.amazonaws.com", "s3.amazonaws.com", "rds.amazonaws.com"]
    }
  }
}
